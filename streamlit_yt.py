...
#### :heavy_check_mark: Цель проекта: аналитика популярности и доходности YouTube-каналов.

#### :heavy_check_mark: Задачи: 
##### :one: Визуализация основных статистик популярности и доходности каналов.
##### :two: Изучение настроения аудитории каналов.
##### :three: Выявление лидирующих по показателям популярности видео на каналах.
##### :four: Выявление лидирующих по показателям доходности проектов на каналах.
...
##### :five: Прибыльность проектов:

Для всех каналов прибыльным является проект **Аргументы и факты**. """
