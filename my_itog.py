...
def visualize_data(topic):
    ...
    if topic == "Каналы":
        ...
        SELECT Projects.Title AS Project, Incomes.Amount, Incomes.CreationDate, Channels.Title AS Channel
        FROM Incomes
        ...
        costs_df = fetch_data('''
        SELECT Projects.Title AS Project, Costs.Amount, Costs.CreationDate, Channels.Title AS Channel
        FROM Costs
